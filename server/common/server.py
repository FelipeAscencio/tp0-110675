...
class Server:
    ...
    def __init__(self, port, listen_backlog, clients):
        ...
        self. client_sockets = []
        self.finished_clients = 0   # Modificación de código para implementar la lógica del ejercicio 7.
        self.winners = []   # Modificación de código para implementar la lógica del ejercicio 7.
